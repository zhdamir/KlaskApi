...
namespace KlaskApi.Migrations
{
    ...
    [Migration("20231123083833_TurnierTeilnehmerUndGruppeIdIsRequieredRemoved2")]
    partial class TurnierTeilnehmerUndGruppeIdIsRequieredRemoved2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KlaskApi.Models.LoginDaten", b =>
                {
                    ...
                    b.ToTable("LoginDaten", (string)null);
                });
            ...
            modelBuilder.Entity("KlaskApi.Models.Gruppe", b =>
                {
                    b.HasOne("KlaskApi.Models.Turnier", null)
                        .WithMany()
            ...
            modelBuilder.Entity("KlaskApi.Models.LoginDaten", b =>
                {
                    b.HasOne("KlaskApi.Models.Teilnehmer", null)
                        .WithOne()
                        .HasForeignKey("KlaskApi.Models.LoginDaten", "TeilnehmerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("KlaskApi.Models.Spiel", b =>
                {
                    b.HasOne("KlaskApi.Models.Runde", null)
                        .WithMany()
